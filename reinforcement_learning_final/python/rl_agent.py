...
"""
Agent Description: (I was told that 15-20 lines is ok. I have 17 lines. There are approximately 80 characters per line w/o spaces.)
...
References: https://medium.com/@tuzzer/cart-pole-balancing-with-q-learning-b54c6068d947
...
class CartPoleAgent:
    ...
    def action(self, state):
        ...
        c_state = self.process_state(state) # Processing the states for the Q-table.
